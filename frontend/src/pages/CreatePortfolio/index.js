    ...
    return (
        ...
        <section className={'main-container'} style={{padding: '0 10%', width: '100%', height: '100%'}}>
            ...
            <UserInfoForm>
                ...
                <UserInfo>
                    <NameWrapper>이메일<div style={{marginLeft: '10px', display:'inline-block', fontWeight:'400'}}>{user.email? user.email : ''}</div></NameWrapper>
                    <NameWrapper>전화번호<div style={{marginLeft: '10px', display:'inline-block', fontWeight:'400'}}>{user.phone? user.phone : ''}</div></NameWrapper>
                </UserInfo>
            </UserInfoForm>
