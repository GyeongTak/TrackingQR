    ...
    return (
        ...
        <div css={container}>
            ...
            <div class={"RightSection"}>
                ...
                <h1 >LIBERA PILATES</h1>
                <Button style={{marginRight:"10px"}} icon={<HeartOutlined />}>찜하기</Button>
                <Button icon={<ShareAltOutlined />}>공유하기</Button>
                </div>

                <h2>프로젝트 설명</h2>
                <p>프로젝트 설명....프로젝트 설명....프로젝트 설명....프로젝트 설명....</p>
